...
- Rôle au **Management Group** â†’ S'applique à **toutes** les subscriptions et ressources sous-jacentes
- Rôle à la **Subscription** â†’ S'applique à **tous** les Resource Groups et ressources
- Rôle au **Resource Group** â†’ S'applique à **toutes** les ressources du groupe
- Rôle à une **Resource** â†’ S'applique **uniquement** à cette ressource
...
- ❌ à‰VITER Owner/Contributor au niveau Subscription
