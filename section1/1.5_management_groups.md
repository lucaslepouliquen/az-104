...
| **Resource Group Lock** | ✅ S'applique à **toutes** les ressources du RG | Lock sur RG â†’ Protège toutes les VMs, Storage, etc. |
| **Resource Lock** | ❌ S'applique **uniquement** à cette ressource | Lock sur VM1 â†’ Protège uniquement VM1 |
