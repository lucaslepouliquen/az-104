...
- **Capacités** : 
  - **IP Flow Verify** : Permet de simuler un flux réseau et de vérifier si celui-ci est autorisé (Allow) ou bloqué (Deny) en fonction des règles NSG (Network Security Group) et des règles d'administration Azure Virtual Network Manager. Vérifier si NSG autorise/bloque le trafic
