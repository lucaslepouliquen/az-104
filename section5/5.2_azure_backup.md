...
14 days by default is the retention period for data after a VM and its restore points have been soft deleted.

9,999 days is the maximum value that you can specify for daily backup retention when you create a custom backup policy.
