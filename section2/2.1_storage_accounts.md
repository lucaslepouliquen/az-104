...
- **Important** : GPv2 supporte uniquement les Standard File Shares (HDD). Pour Premium File Shares, utilisez un compte FileStorage.
...
- **Note** : Ne pas confondre avec "BlobStorage" (ancien type de compte deprecated)
...
**Tips :**
- Utiliser un FileStorage account pour les Premium File Shares
...
- Sont utilisé pour les disques de VMs et les volumes Kubernetes ;
- Sont accessbiles via une interface de type disque montée comme volume (/dev/sda, C:\).
...
- Durabilité : 99.9 999 999 999% (12 nines)
...
- Durabilité : 99.99 999 999 999 999% (16 nines)
