...
|------|----------|--------------|---------------|------------|---------|-----------|----------------------|
| **Hot** | Données fréquemment accédées | Immédiate | $$$ àlevé | $ Faible | Ms | Aucune | Non |
| **Cool** | Données peu accédées (>30 jours) | Immédiate | $$ Moyen | $$ Moyen | Ms | 30 jours | Oui |
| **Cold** | Données rarement accédées (>90 jours) | Immédiate | $ Faible | $$$ àlevé | Ms | 90 jours | Oui |
...
**A. Standard Rehydration (àconomique)**
...
| Tier | Stockage/mois | Accès (100 read/mois) | Total/an | àconomie vs Hot |
|------|---------------|----------------------|----------|-----------------|
| **Hot** | $18 | $0.04 | $216.48 | - |
...
```bash
# àtape 1 : Créer la policy sur destination (génère policy ID)
...
# àtape 2 : Appliquer la policy sur source
...
3. àcritures toujours vers Europe (source)
...
**àtape 1 : Créer Azure CDN Profile et Endpoint**
...
**àtape 2 : Configurer DNS pour Custom Domain**
...
**àtape 3 : Ajouter Custom Domain au CDN Endpoint**
